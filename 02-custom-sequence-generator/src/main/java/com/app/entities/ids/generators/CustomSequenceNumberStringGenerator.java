package com.app.entities.ids.generators;
...
import com.app.entities.DomainObject;

public class CustomSequenceNumberStringGenerator implements IdentifierGenerator, Configurable 
{
	...
	public Serializable generate(SharedSessionContractImplementor session, Object obj) {
		...
		if (obj instanceof DomainObject) {
			DomainObject identifiable = (DomainObject) obj;
		...
		long seqValue = ((Number)Session.class.cast(session).createNativeQuery(sequenceCallSyntax).uniqueResult()).longValue();
